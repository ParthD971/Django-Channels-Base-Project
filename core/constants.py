...
ACCOUNT_ACTIVATION_LINK_SENT = 'Link for account activation is sent to your email.'
...
ACCOUNT_FORGOT_PASSWORD_LINK_SENT = 'Link for restore password is sent to your email.'
ACCOUNT_PASSWORD_RESTORE_SUCCESS = 'Password restored successful. You must login again.'
